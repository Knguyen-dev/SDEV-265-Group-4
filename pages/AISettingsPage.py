...
class AISettingsPage(ctk.CTkFrame):
	def __init__(self, master):
		...
		for x in range(len(formFields)):
			...
			slider = tk.Scale(formFieldsSection, from_=formFields[x]["lower"], to=formFields[x]["upper"], resolution=0.01, orient="horizontal", bg="#0E4732", length=200, variable=sliderVar)
